...
public class Optionsmenue extends Hauptmenue implements ActionListener, KeyListener{
    private Font font;
    private static Knopf steuerung, fenstergroesse, lautstaerke, zurueckInsHauptmenue, zurueckInsOptionsmenue; //Im Optionsmenü
    ...
    protected void paintComponent(Graphics g){
        ...
        zurueckInsHauptmenue.skallieren(getWidth(), getHeight());
